...
<option value="1">📻 Рация (PTT — нажал и говоришь)</option>
<option value="0">📞 Телефон (полнодуплекс, всегда включён)</option>
</select>
</div>
